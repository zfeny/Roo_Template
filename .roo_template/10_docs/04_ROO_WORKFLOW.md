...
1. `bash .roo_template/09_automations/01_scripts/00_wo.sh kickoff-wo WO-YYYYMMDD-001 short`
...
2. Fill `.roo_template/03_work_orders/WO-YYYYMMDD-001/01_WorkOrder.md`, then commit `work-order` stage.
3. `bash .roo_template/09_automations/01_scripts/00_wo.sh prepare-context WO-YYYYMMDD-001`, then commit `context`.
4. Implement changes, then commit `implementation`.
5. `bash .roo_template/09_automations/01_scripts/00_wo.sh quality WO-YYYYMMDD-001`, then commit `quality`.
...
## Git Hooks (Optional)
1. `bash .roo_template/09_automations/01_scripts/08_install_git_hooks.sh`
