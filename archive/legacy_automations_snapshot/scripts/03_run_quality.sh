...
WO="$1"
PROFILE="${2:-fast}"
OUT_DIR=".roo_process/quality/04_reports/${WO}"
...
run_and_log "validate-quality" "bash .roo_process/automations/scripts/05_validate_wo.sh ${WO} quality"

echo >> "${RPT}"
printf 'Logs: `%s`\n' ".roo_process/quality/04_reports/${WO}/03_logs" >> "${RPT}"
