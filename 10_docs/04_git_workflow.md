...
* `bash 09_automations/01_scripts/01_new_work_order.sh <WO_ID> <slug>`
* `bash 09_automations/01_scripts/06_git_control_check.sh <WO_ID> branch`
...
* `bash 09_automations/01_scripts/09_git_commit_stage.sh <WO_ID> work-order`
...
* `bash 09_automations/01_scripts/09_git_commit_stage.sh <WO_ID> context`
...
* `bash 09_automations/01_scripts/09_git_commit_stage.sh <WO_ID> implementation`
...
* `bash 09_automations/01_scripts/09_git_commit_stage.sh <WO_ID> quality`
...
* `bash 09_automations/01_scripts/09_git_commit_stage.sh <WO_ID> delivery`
...
* `bash 09_automations/01_scripts/11_prepare_review.sh <WO_ID>`
...
* `bash 09_automations/01_scripts/09_git_commit_stage.sh <WO_ID> review`
...
* `bash 09_automations/01_scripts/10_git_merge_wo.sh <WO_ID> <slug>`
