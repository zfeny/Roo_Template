...
## 2) 迁移映射（旧 -> 新）
- `.roo_template/02_templates/*` -> `.roo_process/templates/*`
- `.roo_template/03_work_orders/*` -> `.roo_process/work_orders/*`
- `.roo_template/04_context_packs/*` -> `.roo_process/context_packs/*`
- `.roo_template/06_quality/*` -> `.roo_process/quality/*`
- `.roo_template/09_automations/*` -> `.roo_process/automations/*`
- `.roo_template/10_docs/*` -> `.roo_process/docs/*`
- `.roo_template/01_spec_locked/*` -> `_SPECs/*`（并取消 spec_locked 概念）
...
- 废弃入口：根目录 `changes/ evidence/ scripts/ specs/ .roo_template/`（已迁移或归档）
